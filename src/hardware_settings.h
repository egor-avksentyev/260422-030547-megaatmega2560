...
// Y=26 — НЕ та же строка (15), что у AC-напряжения ниже: обе делили Y=15 с самого добавления
// прокрутки, и подпись "AC:<значение>V" достаточно длинная (например "AC:230V" от X=75), чтобы
// физически залезать поверх этого индикатора при X=108 — выглядело как каша из цифр/"/"/"-".
// 26 — между подчёркиванием заголовка (Y=15+3=18) и началом списка (INFO_LIST_Y_START=38)
#define INFO_SCROLL_INDICATOR_FONT u8g2_font_5x7_tr
#define INFO_SCROLL_INDICATOR_X 108
#define INFO_SCROLL_INDICATOR_Y 26
